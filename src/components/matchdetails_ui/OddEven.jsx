...
const OddEvenComponent = ({ data, onBetSelect }) => {
  ...
  return (
    <div className="space-y-0 bg-[#1a2027] rounded-lg overflow-hidden mt-2">
...
const OddEven = memo(OddEvenComponent, arePropsEqual);
